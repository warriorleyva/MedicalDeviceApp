...
extern void *mono_aot_module_MedicalPhotonDevice_iOS_info;
...
extern void *mono_aot_module_MedicalPhotonDevice_info;
...
{
	mono_aot_register_module (mono_aot_module_MedicalPhotonDevice_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_MedicalPhotonDevice_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MedicalPhotonDevice.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
